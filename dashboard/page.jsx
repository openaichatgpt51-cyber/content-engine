  ...
  return (
    <div style={{ padding: '32px 36px', flex: 1 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 32 }}>
        ...
        <a href="/dashboard/new-post" className="press hover-lift" style={{
          display: 'flex',
          alignItems: 'center',
          gap: 8,
          padding: '11px 20px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)' }}>
            {calDays.map(({ date, current }, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`cal-day${dayPosts.length ? ' cal-day--clickable' : ''}`}
                  style={{
                    minHeight: 110,
                    padding: '8px 10px',
                    borderRight: (idx + 1) % 7 !== 0 ? '1px solid var(--fog-60)' : 'none',
        ...
        >
          <div className="slide-in-right" style={{
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 20 }}>
              <a href={`/dashboard/review`} className="press hover-lift" style={{
                flex: 1,
                padding: '10px 0',
                textAlign: 'center',
                background: 'var(--ink)',
