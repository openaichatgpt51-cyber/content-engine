...
const PLATFORMS = [
  ...
  },
  {
    ...
    betaNote: 'You can connect now, but posts won\u2019t publish here until the site goes live \u2014 LinkedIn only for now',
  },
]
              ...
              <div key={p.key} style={{
                ...
                <div style={{ flex: 1 }}>
                    ...
                    {p.betaNote && (
                      <span
                        ...
                        style={{
                          ...
                          fontStyle: 'italic',
                          cursor: 'help',
                          borderBottom: '1px dotted var(--ink-20)',
                        }}
                      >
                        (posting begins at launch)
                      </span>
                    )}
                    {p.comingSoon ? (
                      <span style={{
                  ...
                  <p style={{ fontSize: '0.8125rem', color: 'var(--ink-20)', marginTop: 3 }}>
                    {p.comingSoon
                      ? 'Instagram publishing is on the way — check back soon'
                      : isConn && conn.account_id ? `Account: ${conn.account_id}` : p.desc}
                  </p>
                  {expired && !p.comingSoon && (
                ...
                {p.comingSoon ? (
                  <span
                    title="Instagram connections open soon"
                    style={{
                      padding: '9px 18px',
